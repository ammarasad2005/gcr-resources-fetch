...
async function downloadAsZip(files, mode, convertToPdf, onProgress) {
  ...
  // If there are external links, generate and add the HTML file to the root of the ZIP
  if (linkFiles.length > 0) {
    report(0, downloadFiles.length, 'Generating External Resources Dashboard…');
    try {

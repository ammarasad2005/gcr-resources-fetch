...
<Relationships xmlns="http://schemas.openxmlformats.org/package/2006/relationships">
  ...
  relsEntries += `<Relationship Id="rId1" Type="http://schemas.openxmlformats.org/officeDocument/2006/relationships/styles" Target="styles.xml"/>\n`;

  links.forEach((link, idx) => {
    const escapedUrl = escapeXml(link.url);
    const relId = `rId${idx + 2}`; // Start at rId2 (since rId1 is styles.xml)
